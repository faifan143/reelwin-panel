      ...
      <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-xl overflow-hidden border border-gray-200">
        ...
        <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 px-8 py-6">
          <div className="flex justify-between items-center">
            ...
            <button
              className="text-white hover:text-red-100 transition-colors flex items-center gap-2 bg-red-500 hover:bg-red-600 px-4 py-2 rounded-lg shadow-md transform hover:scale-105 duration-300"
              onClick={onLogout}
            >
        ...
        {/* Tabs */}
        <div className="bg-gradient-to-b from-gray-100 to-white px-8 py-4 border-b">
          <ul className="flex space-x-4 space-x-reverse">
            <li>
              <button
                className={`py-2 px-8 font-semibold rounded-lg shadow-sm transition-all duration-300 ${
                  activeTab === "add"
