...
import { MediaPreviewProps } from "./type";
          ...
          <div
            className={
              isVideo
                ...
                : "absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-between p-2"
            }
          >
            <button
              type="button"
